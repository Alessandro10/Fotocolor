...
(function (factory) {
    ...
    tActions = '<div class="file-actions">\n' +
      ...
      //  '        {delete}{other}' + //'        {upload}{delete}{other}' +
        '    </div>\n' +
    ...
    tHtml = '<div class="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}">\n' +
        ...
        '   {footer}\n' +
        '</div>';
    tImage = '<div class="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}" style="height:155px;margin-left:0px; margin:0px;">\n' +
        '   <img src="{data}" name="presentazione-img" ondblclick="doppioclick(src)" draggable="true" ondragstart="drag(event)" class="file-preview-image" title="{caption}" alt="{caption}" ' + STYLE_SETTING + '>\n' +
        '   {footer}\n' +
        '</div>\n';
    ...
    tObject = '<div class="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}"' +
        ...
        '   {footer}\n' +
        '</div>';
    tOther = '<div class="file-preview-frame{frameClass}" draggable="true" ondragstart="drag(event)" id="{previewId}" data-fileindex="{fileindex}"' +
        ' title="{caption}"  ' + STYLE_SETTING + '>\n' +
		...
		for (var i = 0, f; f = files[i]; i++) {
			...
			reader.onload = (function(theFile) {
				...
				return function(e) {
					...
					global = src;
					jj++;
					//"12-.JPG" "11.JPG" "11-.JPG" "12.JPG" 
					$("#invisibletext").append('<input type="text" id="casella' + jj + '" name="' + name + '" class="col-md-12 recupero hidden"/>');
					//$("#invisibletext").append('<img name="'+ name + '" src="' + src + '"/>');
					//$("#invisibletext").append('<input type="text" id="casella' + jj + '" class="col-md-12"/>');
					//$("#casella" + jj).val(src);
					$("#casella" + jj).attr("url" , src);
    ...
    $.fn.fileinputLocales.en = {
        fileSingle: 'file',
        filePlural: 'files',
        browseLabel: 'Il tuo PC',//'Browse &hellip;',
        removeLabel: 'Rimuovi',//'Remove',
