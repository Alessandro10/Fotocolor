...
(function($){
	...
	$.jWindowCrop = function(image, options){
		...
		base.init = function(){
			...
			base.$image.addClass('jwc_image').wrap('<div class="jwc_frame" onscroll="zoomimg()" />'); // wrap image in frame
		...
		function handleMouseMove(event) {
			//alert("handlerMouseMove");
			//alert($("#target3").data('draggable'));
			//alert("cc");
			result = $("#target3").attr('draggable');
			if(base.isDragging && result != "yes") {
				//alert(result);
